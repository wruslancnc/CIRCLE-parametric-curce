...
fxn_cacc_x (double u)
{
  ...
  */
  ...
  /*
    ...
    // double dx_du = ( -2*k*sin(k*u)    - 5*(2*k/3)*sin(2*k*u/3) );        //
    DX double d2x_du2 = ( -2*k*k*cos(k*u)  - 5*(2*k/3)*(2*k/3)*cos(2*k*u/3) );
    // D2X return (scaleup)*(d2x_du2);
  */
  // ========================================
  /*
    // EPICYCLOID D2X
    ...
    double d2x =   ( -5*k*k*cos(k*u + small) + (5*k)*(5*k)*cos(5*k*u - small));
    // D2X return (scaleup)*(d2x);
  */
  // =========================================
  /*
    ...
    double d2x_epi = -5.0*k*k*cos(k*u + small) + (5.0*k)*(5.0*k)*cos(5*k*u -
    small); double d2x = d2x_ast + d2x_epi; return (scaleup)*(d2x);
  */
  // ==========================================
  /*
